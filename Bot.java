...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        switch (txt) {
            ...
            case "/newsR":
                try {
                    Parser.getPars().forEach(x -> sendMsg(message, x.toString()));
            ...
            case "/policyR":
                try {
                    for (int i = 0; i < 5 ; i++) {
                        sendMsg(message, Parser.getParsPolicy().get(i).toString());
                    }
                    System.out.println("Sent successfully");
                } catch (IOException e) {
                    e.printStackTrace();
            ...
            case "/mobileR":
                try {
                    for (int i = 0; i < 5; i++) {
                        sendMsg(message, Parser.getParsMobile().get(i).toString());
                    }
                    System.out.println("Sent successfully");
                } catch(IOException e){
                    e.printStackTrace();
            ...
            case "/carR":
                try {
                    for (int i = 0; i < 5; i++) {
                        sendMsg(message, Parser.getParsAuto().get(i).toString());
                    }
                    System.out.println("Sent successfully");
                }catch(IOException e){
                    e.printStackTrace();
            ...
            case "/sportR":
                try {
                    for (int i = 0; i < 5; i++) {
                        sendMsg(message, Parser.getParsSport().get(i).toString());
                    }
                    System.out.println("Sent successfully");
                } catch(IOException e){
                    e.printStackTrace();
            ...
            case "/artR":
                try {
                    for (int i = 0; i < 5; i++) {
                        sendMsg(message, Parser.getParsArt().get(i).toString());
                    }
                    System.out.println("Sent successfully");
                } catch(IOException e){
                    e.printStackTrace();
