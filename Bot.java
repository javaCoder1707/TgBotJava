...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        switch (txt) {
            ...
            case "/policyR":
                try {
                    List<ResultRU> results = ParserRU.getParsPolicy();
            ...
            case "/mobileR":
                try {
                    List<ResultRU> results = ParserRU.getParsMobile();
            ...
            case "/carR":
                try {
                    List<ResultRU> list = ParserRU.getParsCars();

                    for (int i = 0; i < 5; i++) {
                        Thread.sleep(1000);
                        sendMsg(message, list.get(i).toString());
                    }
            ...
            case "/sportR":
                try {
                    List<ResultRU> results = ParserRU.getParsSport();
            ...
            case "/artR":
                try {
                    List<ResultRU> results = ParserRU.getParsArt();
            ...
            case "/newsUK":
                try {
                    List<ResultUK> results = ParserUK.getParsUK();
            ...
            case "/newsWorld":
                try {
                    List<ResultUK> results = ParserUK.getParsWorld();
            ...
            case "/politic":
                try {
                    List<ResultUK> results = ParserUK.getParsPolitic();
            ...
            case "/motors":
                try {
                    List<ResultUK> results = ParserUK.getParsMotors();
            ...
            case "/sport":
                try {
                    List<ResultUK> results = ParserUK.getParsSport();
